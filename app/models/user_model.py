...
userName = Column(String(255), unique=True, nullable=False) # Keep 255 (lebih aman dari 50)
...
userGPA = Column(Float) # Jangan dibuang, ini fitur core
streak = Column(Integer, default=0) # Jangan dibuang
userDOB = Column(Date)

# --- UPDATE DARI TEMAN (Diadopsi) ---
# Menambahkan kolom avatar tipe String untuk URL
